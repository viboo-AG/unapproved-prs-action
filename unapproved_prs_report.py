...
def _generate_report(
    ...
    print("## How to Review", file=f)
    print("", file=f)
    print("Choose one of the following methods to approve a PR:", file=f)
    print("", file=f)
    print("### Option 1: GitHub Mobile App (Recommended)", file=f)
    print("", file=f)
    print("GitHub's mobile app allows you to approve already-merged PRs:", file=f)
    print("", file=f)
    print("1. Open the **GitHub mobile app** (iOS or Android)", file=f)
    print("2. Navigate to the PR from the list above", file=f)
    print("3. Tap **\"Review changes\"**", file=f)
    print("4. Review the code and add comments if needed", file=f)
    print("5. Select **\"Approve\"** and submit", file=f)
    print("", file=f)
    print("### Option 2: GitHub CLI", file=f)
    print("", file=f)
    print("Use the GitHub CLI to approve from the command line:", file=f)
    print("", file=f)
    print("```bash", file=f)
    print("gh pr review <PR-NUMBER> --approve --body \"Post-merge review: changes look good\"", file=f)
    print("```", file=f)
    print("", file=f)
    print("Example:", file=f)
    print("```bash", file=f)
    print("gh pr review 3170 --approve --body \"Reviewed emergency fix - approved\"", file=f)
    print("```", file=f)
    print("", file=f)
    print("### Option 3: Add Review Comment", file=f)
    print("", file=f)
    print("If you can't use the mobile app or CLI, add a comment on the PR:", file=f)
    print("", file=f)
    print("```", file=f)
